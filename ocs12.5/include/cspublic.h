...
**	Copyright  Sybase, Inc. 1992, 2001, 2002, 2003
**	All rights reserved
*/
...
#define CS_IMPCURSTAT_DECLARED 		(CS_INT)0x1
#define CS_IMPCURSTAT_READROWS		(CS_INT)0x2
#define CS_IMPCURSTAT_CLOSED		(CS_INT)0x4
#define CS_IMPCURSTAT_SENDSUCCESS	(CS_INT)0x8
#define CS_IMPCURSTAT_FINALREAD		(CS_INT)0x10
#define CS_IMPCURSTAT_NOSEND		(CS_INT)0x20
#define CS_IMPCURSTAT_NOSENDDONE	(CS_INT)0x40
...
#define CS_MAX_REQ_CAP		CS_DATA_INTERVAL
