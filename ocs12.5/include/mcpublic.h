...
/* Seting up configurable memory limits */
extern SMC_RETURN_CODE CS_PUBLIC  
smc_MaxMem PROTOTYPE ((
  SMC_CONNECT_ID	clientIdHandle,
  SMC_INT			max 
  ));


/*  switching tracing options on and off */
extern SMC_RETURN_CODE CS_PUBLIC
smc_trace PROTOTYPE ((
  SMC_INT                       opt /*bitwise tracing option */
  ));
